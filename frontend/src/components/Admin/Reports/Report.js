...
import monthsData from '../../Dummy/Analytics/months.json';
import oemsData from '../../Dummy/Analytics/oems.json';
import chartData from '../../Dummy/Analytics/chartData.json';
...
const AnalyticsPage = () => {
  ...
  return (
    <div className="analytics-page">
      ...
      <div className="stats">
        <h2>Total Quantity Sold: <span>100</span></h2>
        <h3>Leads Success: <span>80%</span></h3>
      </div>
